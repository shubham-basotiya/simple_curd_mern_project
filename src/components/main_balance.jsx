    ...
    render() { 
        ...
        return (
            <div>
                ...
                {this.state.mainBalance === undefined && this.setState({mainBalance: prompt("Enter main balance", 0)})}
                {this.state.mainBalance !== undefined && <h1>Main Balance : {this.state.mainBalance}</h1>}
